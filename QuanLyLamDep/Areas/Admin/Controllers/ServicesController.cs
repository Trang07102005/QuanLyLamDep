...
namespace QuanLyLamDep.Areas.Admin.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServiceID,ServiceGroupID,Name,Description,Price,Duration,Status")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServiceID,ServiceGroupID,Name,Description,Price,Duration,Status")] Service service)
        {
            if (ModelState.IsValid)
            {
